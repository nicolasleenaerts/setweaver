...
descriptives = entfuns(misimdata$y,misimdata[,2:5])
```

```{r table_4,echo=FALSE,results='asis'}
knitr::kable(entfuns(misimdata$y,misimdata[,2:5]),caption = 'Table 4. Diagnostic statistics from entfuns()',align = c('c'))
```
